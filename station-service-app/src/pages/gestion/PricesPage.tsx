    ...
    },
    {
      ...
      render: (p) => (
        <span className="font-semibold text-primary-600">
          {p.sellingPriceTTC.toFixed(2)} MAD/L
        </span>
      ),
    },
    {
      key: 'sellingPriceHT',
      label: 'Prix vente HT',
      render: (p) => `${p.sellingPriceHT.toFixed(2)} MAD/L`,
    },
    {
      key: 'purchasePrice',
      label: "Prix d'achat",
      render: (p) => `${p.purchasePrice.toFixed(2)} MAD/L`,
    },
    {
      key: 'margin',
      label: 'Marge',
      render: (p) => {
        const margin = p.sellingPriceHT - p.purchasePrice;
        return (
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-secondary-500">Gerez les prix de vente et d'achat</p>
        </div>
        <button
