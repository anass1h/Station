...
export class SaleController {
  ...
  @ApiResponse({ status: 400, description: 'Données invalides ou shift non ouvert' })
  @ApiResponse({ status: 404, description: 'Shift, type de carburant ou client non trouvé' })
  ...
  @ApiParam({ name: 'shiftId', description: 'UUID du shift' })
  @ApiResponse({ status: 200, description: 'Résumé des ventes (totaux, par type, par paiement)' })
  ...
  @ApiQuery({ name: 'clientId', required: false, description: 'Filtrer par client' })
